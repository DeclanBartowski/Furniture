	...
	<div class="unified-inner_content">
        <? if ($arResult['ORDER']['ORDER_ID']) { ?>
			<div class="order-placed_box">
				<div class="order-placed_icon">
					<img alt="alt" src="<?= SITE_TEMPLATE_PATH ?>/img/icons/checkout-icon.svg">
				</div>
				<p class="text-upper">Ваш заказ успешно оформлен!</p>
				<a href="/catalog/" class="main-btn">Перейти в каталог</a>
			</div>
        <? } else { ?>
			<div class="no-active_purchases">
		                <span class="no-active_purchases_icon">
			                <img alt="alt" src="<?= SITE_TEMPLATE_PATH ?>/img/icons/cart-icon.svg">
		                </span>
				<p class="text-upper"> <?= $arResult['ORDER']['MESSAGE']; ?></p>
