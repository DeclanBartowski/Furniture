...
<? if (!empty($arResult['ITEMS'])) { ?>
	<div class="product-section">
		<div class="product-section_header">
			...
			<a href="/catalog/" class="see-all_btn mobile-hidden">Смотреть все<span class="ico-arrow"></span></a>
		</div>
		...
		<div class="mobile-visible">
			<a href="/catalog/" class="see-all_mobile-btn main-btn">Смотреть все</a>
		</div>
	</div>
<? } ?>
