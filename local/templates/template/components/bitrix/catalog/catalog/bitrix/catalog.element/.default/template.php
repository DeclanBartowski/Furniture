	...
	<div class="col-md-8 product-card_left-cell">
        ...
        <? if (!empty($arResult['PROPERTIES']['MANUFACTURER']['ITEM_VALUE'])) { ?>
			<div class="product-card_middle-panel">
                ...
                <? if (!empty($arResult['DETAIL_TEXT']/*$arResult['PROPERTIES']['MANUFACTURER']['ITEM_VALUE']['UF_DESCRIPTION']*/)) { ?>
					<div class="text-column">
						<p><?= $arResult['DETAIL_TEXT']/*$arResult['PROPERTIES']['MANUFACTURER']['ITEM_VALUE']['UF_DESCRIPTION']*/; ?></p>
					</div>
                <? } ?>
			</div>
        <? } ?>
